    ...
    <nav className="bg-white border-b border-slate-200 sticky top-0 z-50">
      <div className="max-w-5xl mx-auto px-4">
        <div className="flex items-center justify-between h-16 gap-3">
          ...
          <button
            onClick={openSearch}
            className="flex items-center gap-2 px-3 py-2 rounded-xl text-sm text-slate-500 bg-slate-50 border border-slate-200 hover:bg-white hover:border-slate-300 transition-all shrink-0"
            aria-label="Pesquisar"
          >
            <Search className="w-4 h-4" />
            <span className="hidden sm:block text-slate-400 text-xs">Pesquisar</span>
            <kbd className="hidden md:flex items-center text-[10px] text-slate-400 bg-white border border-slate-200 rounded px-1 font-mono leading-none py-0.5">
              Ctrl K
            </kbd>
          </button>
        ...
        {open && (
          <div className="md:hidden border-t border-slate-100 py-2">
            ...
            <button
              ...
              className="w-full text-left px-4 py-3 text-sm font-medium rounded-lg mx-1 text-slate-700 hover:bg-slate-50 flex items-center gap-2"
            >
